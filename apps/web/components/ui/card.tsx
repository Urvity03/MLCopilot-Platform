    ...
    return (
      <motion.div
        ...
        className={cn(
          ...
          hoverLift && "transition-all duration-300 hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-indigo-950/20 hover:border-indigo-500/20",
          hoverGlow && "glow-hover-indigo",
          className
        )}
        {...props}
      />
